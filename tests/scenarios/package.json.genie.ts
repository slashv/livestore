...
export default packageJson(
  {
    ...
    scripts: {
      ...
      'viewer:react': 'pnpm exec vite --config scenario-viewer-react.vite.config.ts',
      'viewer:react:build': 'pnpm exec vite build --config scenario-viewer-react.vite.config.ts',
