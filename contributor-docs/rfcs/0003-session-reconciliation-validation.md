...
See [the current architecture RFC](./0003-serialized-sync-processors.md#safe-session-reconciliation-steps) and
[the C comparison](./0003-session-single-owner-experiment.md). The A/B measurements below are distinct from the later
